...
Tree Navigator installs as `+tree-navigator+`, but we recommend the
short alias *`+tn+`* (Tree Navigator).
...
This will detect your shell and add `+alias tn='tree-navigator'+` to the
...
* *Documentation:*
https://gitlab.com/hyperpolymath/tree-navigator/-/wikis/home
...
After installation: 1. Read the
https://gitlab.com/hyperpolymath/tree-navigator/-/wikis/User-Guide[User
Guide] 2. Try the examples: `+tn --help+` 3. Set up shell completion (if
available) 4. Explore interactive mode: `+tn+`
