...
// Replace tree-navigator, Tree Navigator — See README.adoc for details., just run, Tree Navigator started successfully. with actuals
= tree-navigator — Quick Start for Users
:toc:
:toclevels: 2

== What is tree-navigator?

Tree Navigator — See README.adoc for details.
...
[source,bash]
----
just install --portable --prefix=./tree-navigator-portable
----
...
[source]
----
Tree Navigator started successfully.
----
...
* **Wiki**: https://github.com/hyperpolymath/tree-navigator/wiki
